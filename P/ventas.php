...
switch ($periodo) {
    ...
    case 'mes':
        ...
        $label_periodo = 'Este mes (' . strftime('%B', mktime(0,0,0,date('m'),1)) . ')';
        break;
    default: // hoy
...
<div class="container-fluid px-4 pb-5">
    ...
    <div class="d-none d-print-block mb-4">
        <h3 class="fw-bold">Restaurante Cardón — Reporte de Ventas</h3>
        ...
        <div class="col-12">
            <div class="seccion-card">
                <div class="seccion-header">
                    ...
                    Pedidos completados
                    <span class="badge bg-secondary ms-auto"><?= count($pedidos) ?></span>
                </div>
